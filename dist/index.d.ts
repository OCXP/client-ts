...
type ServerSentEventsOptions<TData = unknown> = Omit<RequestInit, 'method'> &
  Pick<Config$1, 'method' | 'responseTransformer' | 'responseValidator'> & {
    /**
...
interface Config<T extends ClientOptions = ClientOptions>
  extends Omit<RequestInit, 'body' | 'headers' | 'method'>, Config$1 {
  /**
 ...
 * Bulk read content.
 */
declare const bulkReadContent: <ThrowOnError extends boolean = false>(
  options: Options<BulkReadContentData, ThrowOnError>
) => RequestResult<BulkReadContentResponses, BulkReadContentErrors, ThrowOnError, 'fields'>;
/**
 * Bulk Write Content
 *
 * Bulk write content with metadata sidecar and KB auto-indexing support.
 */
declare const bulkWriteContent: <ThrowOnError extends boolean = false>(
  options: Options<BulkWriteContentData, ThrowOnError>
) => RequestResult<BulkWriteContentResponses, BulkWriteContentErrors, ThrowOnError, 'fields'>;
/**
 * Bulk Delete Content
 *
 * Bulk delete content with KB auto-removal support.
 */
declare const bulkDeleteContent: <ThrowOnError extends boolean = false>(
  options: Options<BulkDeleteContentData, ThrowOnError>
) => RequestResult<BulkDeleteContentResponses, BulkDeleteContentErrors, ThrowOnError, 'fields'>;
/**
 ...
 * ```
 */
declare const listPrototypeChats: <ThrowOnError extends boolean = false>(
  options?: Options<ListPrototypeChatsData, ThrowOnError>
) => RequestResult<ListPrototypeChatsResponses, ListPrototypeChatsErrors, ThrowOnError, 'fields'>;
/**
 ...
 * ```
 */
declare const previewPrototypeChat: <ThrowOnError extends boolean = false>(
 ...
 * ```
 */
declare const linkPrototypeChat: <ThrowOnError extends boolean = false>(
  options: Options<LinkPrototypeChatData, ThrowOnError>
) => RequestResult<LinkPrototypeChatResponses, LinkPrototypeChatErrors, ThrowOnError, 'fields'>;
/**
 * Sync Prototype Chat
 *
 ...
 * ```
 */
declare const syncPrototypeChat: <ThrowOnError extends boolean = false>(
  options: Options<SyncPrototypeChatData, ThrowOnError>
) => RequestResult<SyncPrototypeChatResponses, SyncPrototypeChatErrors, ThrowOnError, 'fields'>;
/**
 * Get Stored Versions
 *
 ...
 * ```
 */
declare const getStoredVersions: <ThrowOnError extends boolean = false>(
  options: Options<GetStoredVersionsData, ThrowOnError>
) => RequestResult<GetStoredVersionsResponses, GetStoredVersionsErrors, ThrowOnError, 'fields'>;
/**
 * Get Prototype Chat
 *
 ...
 * ```
 */
declare const getPrototypeChat: <ThrowOnError extends boolean = false>(
  options: Options<GetPrototypeChatData, ThrowOnError>
) => RequestResult<GetPrototypeChatResponses, GetPrototypeChatErrors, ThrowOnError, 'fields'>;
/**
 ...
 * ```
 */
declare const syncPrototypeChatAsync: <ThrowOnError extends boolean = false>(
 ...
 * ```
 */
declare const getSyncStatus: <ThrowOnError extends boolean = false>(
  options: Options<GetSyncStatusData, ThrowOnError>
) => RequestResult<GetSyncStatusResponses, GetSyncStatusErrors, ThrowOnError, 'fields'>;
/**
 * List all sessions
 *
 ...
 */
declare const listSessions: <ThrowOnError extends boolean = false>(
  options?: Options<ListSessionsData, ThrowOnError>
) => RequestResult<ListSessionsResponses, ListSessionsErrors, ThrowOnError, 'fields'>;
/**
 * Get session messages
 *
 * Loads message history for a session from S3 storage.
 */
declare const getSessionMessages: <ThrowOnError extends boolean = false>(
  options: Options<GetSessionMessagesData, ThrowOnError>
) => RequestResult<GetSessionMessagesResponses, GetSessionMessagesErrors, ThrowOnError, 'fields'>;
/**
 * Update session metadata
 *
 * Updates session title and message count. Creates session if it does not exist.
 */
declare const updateSessionMetadata: <ThrowOnError extends boolean = false>(
 ...
 */
declare const forkSession: <ThrowOnError extends boolean = false>(
  options: Options<ForkSessionData, ThrowOnError>
) => RequestResult<ForkSessionResponses, ForkSessionErrors, ThrowOnError, 'fields'>;
/**
 * Archive session
 *
 * Soft deletes a session by changing its status to archived.
 */
declare const archiveSession: <ThrowOnError extends boolean = false>(
  options: Options<ArchiveSessionData, ThrowOnError>
) => RequestResult<ArchiveSessionResponses, ArchiveSessionErrors, ThrowOnError, 'fields'>;
/**
 * List all projects
 *
 * Returns all projects in the workspace with their linked repos and missions. Supports offset-based pagination.
 */
declare const listProjects: <ThrowOnError extends boolean = false>(
  options?: Options<ListProjectsData, ThrowOnError>
) => RequestResult<ListProjectsResponses, ListProjectsErrors, ThrowOnError, 'fields'>;
/**
 * Create a new project
 *
 * Creates a project with auto-generated UUID. Projects link repos, missions, and sessions for context scoping.
 */
declare const createProject: <ThrowOnError extends boolean = false>(
  options: Options<CreateProjectData, ThrowOnError>
) => RequestResult<CreateProjectResponses, CreateProjectErrors, ThrowOnError, 'fields'>;
/**
 * Delete project
 *
 * Permanently deletes a project and its metadata. Linked repos are not deleted.
 */
declare const deleteProject: <ThrowOnError extends boolean = false>(
  options: Options<DeleteProjectData, ThrowOnError>
) => RequestResult<DeleteProjectResponses, DeleteProjectErrors, ThrowOnError, 'fields'>;
/**
 * Get project details
 *
 * Returns full project details including linked repos, missions, and metadata.
 */
declare const getProject: <ThrowOnError extends boolean = false>(
  options: Options<GetProjectData, ThrowOnError>
) => RequestResult<GetProjectResponses, GetProjectErrors, ThrowOnError, 'fields'>;
/**
 * Update project
 *
 * Updates project name and/or description. Only provided fields are updated.
 */
declare const updateProject: <ThrowOnError extends boolean = false>(
  options: Options<UpdateProjectData, ThrowOnError>
) => RequestResult<UpdateProjectResponses, UpdateProjectErrors, ThrowOnError, 'fields'>;
/**
 * Link repository to project
 *
 * Links a repository to the project with category, priority, and auto-include settings for KB queries.
 */
declare const addLinkedRepo: <ThrowOnError extends boolean = false>(
  options: Options<AddLinkedRepoData, ThrowOnError>
) => RequestResult<AddLinkedRepoResponses, AddLinkedRepoErrors, ThrowOnError, 'fields'>;
/**
 * Unlink repository from project
 *
 * Removes a repository link from the project. The repository itself is not deleted.
 */
declare const removeLinkedRepo: <ThrowOnError extends boolean = false>(
  options: Options<RemoveLinkedRepoData, ThrowOnError>
) => RequestResult<RemoveLinkedRepoResponses, RemoveLinkedRepoErrors, ThrowOnError, 'fields'>;
/**
 * Set default repository
 *
 * Sets the default repository for the project. Used for integration and primary context.
 */
declare const setDefaultRepo: <ThrowOnError extends boolean = false>(
  options: Options<SetDefaultRepoData, ThrowOnError>
) => RequestResult<SetDefaultRepoResponses, SetDefaultRepoErrors, ThrowOnError, 'fields'>;
/**
 * Get context repositories
 *
 * Returns all repositories marked for auto-include in KB queries.
 */
declare const getContextRepos: <ThrowOnError extends boolean = false>(
  options: Options<GetContextReposData, ThrowOnError>
) => RequestResult<GetContextReposResponses, GetContextReposErrors, ThrowOnError, 'fields'>;
/**
 * Add mission to project
 *
 * Associates a mission with the project for context grouping.
 */
declare const addMission: <ThrowOnError extends boolean = false>(
  options: Options<AddMissionData, ThrowOnError>
) => RequestResult<AddMissionResponses, AddMissionErrors, ThrowOnError, 'fields'>;
/**
 * Remove mission from project
 *
 * Removes the mission association from the project. The mission itself is not deleted.
 */
declare const removeMission: <ThrowOnError extends boolean = false>(
  options: Options<RemoveMissionData, ThrowOnError>
) => RequestResult<RemoveMissionResponses, RemoveMissionErrors, ThrowOnError, 'fields'>;
/**
 * Get project databases
 *
 * Returns all databases linked to the project.
 */
declare const getProjectDatabases: <ThrowOnError extends boolean = false>(
  options: Options<GetProjectDatabasesData, ThrowOnError>
) => RequestResult<GetProjectDatabasesResponses, GetProjectDatabasesErrors, ThrowOnError, 'fields'>;
/**
 * Link database to project
 *
 * Links a database configuration to the project for agent context.
 */
declare const addDatabase: <ThrowOnError extends boolean = false>(
  options: Options<AddDatabaseData, ThrowOnError>
) => RequestResult<AddDatabaseResponses, AddDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Unlink database from project
 *
 * Removes a database link from the project. The database config is not deleted.
 */
declare const removeDatabase: <ThrowOnError extends boolean = false>(
  options: Options<RemoveDatabaseData, ThrowOnError>
) => RequestResult<RemoveDatabaseResponses, RemoveDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Set default database
 *
 * Sets the default database for the project. Used when no specific database_id is provided.
 */
declare const setDefaultDatabase: <ThrowOnError extends boolean = false>(
  options: Options<SetDefaultDatabaseData, ThrowOnError>
) => RequestResult<SetDefaultDatabaseResponses, SetDefaultDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Regenerate mission
 *
 * Archives old generated docs and triggers AgentCore regeneration with updated ticket info.
 */
declare const regenerateMission: <ThrowOnError extends boolean = false>(
 ...
 * @deprecated
 */
declare const queryKnowledgeBase: <ThrowOnError extends boolean = false>(
  options: Options<QueryKnowledgeBaseData, ThrowOnError>
) => RequestResult<QueryKnowledgeBaseResponses, QueryKnowledgeBaseErrors, ThrowOnError, 'fields'>;
/**
 * Rag Knowledge Base
 *
 ...
 * @deprecated
 */
declare const ragKnowledgeBase: <ThrowOnError extends boolean = false>(
  options: Options<RagKnowledgeBaseData, ThrowOnError>
) => RequestResult<RagKnowledgeBaseResponses, RagKnowledgeBaseErrors, ThrowOnError, 'fields'>;
/**
 * List memos
 *
 * List memos for the workspace with optional filters and pagination.
 */
declare const listMemos: <ThrowOnError extends boolean = false>(
  options?: Options<ListMemosData, ThrowOnError>
) => RequestResult<ListMemosResponses, ListMemosErrors, ThrowOnError, 'fields'>;
/**
 * Create memo
 *
 * Create a new memo (general or security finding).
 */
declare const createMemo: <ThrowOnError extends boolean = false>(
  options: Options<CreateMemoData, ThrowOnError>
) => RequestResult<CreateMemoResponses, CreateMemoErrors, ThrowOnError, 'fields'>;
/**
 * Delete memo
 *
 * Delete a memo permanently.
 */
declare const deleteMemo: <ThrowOnError extends boolean = false>(
  options: Options<DeleteMemoData, ThrowOnError>
) => RequestResult<DeleteMemoResponses, DeleteMemoErrors, ThrowOnError, 'fields'>;
/**
 * Get memo by ID
 *
 * Get a specific memo by its ID.
 */
declare const getMemo: <ThrowOnError extends boolean = false>(
  options: Options<GetMemoData, ThrowOnError>
) => RequestResult<GetMemoResponses, GetMemoErrors, ThrowOnError, 'fields'>;
/**
 * Get memo for source
 *
 * Get memo for a specific source entity (repo, project, mission, doc).
 */
declare const getMemoForSource: <ThrowOnError extends boolean = false>(
  options: Options<GetMemoForSourceData, ThrowOnError>
) => RequestResult<GetMemoForSourceResponses, GetMemoForSourceErrors, ThrowOnError, 'fields'>;
/**
 * Resolve memo
 *
 * Mark a memo as resolved. Sets TTL for auto-deletion.
 */
declare const resolveMemo: <ThrowOnError extends boolean = false>(
  options: Options<ResolveMemoData, ThrowOnError>
) => RequestResult<ResolveMemoResponses, ResolveMemoErrors, ThrowOnError, 'fields'>;
/**
 * Acknowledge memo
 *
 * Mark a memo as acknowledged (developer has seen it).
 */
declare const acknowledgeMemo: <ThrowOnError extends boolean = false>(
  options: Options<AcknowledgeMemoData, ThrowOnError>
) => RequestResult<AcknowledgeMemoResponses, AcknowledgeMemoErrors, ThrowOnError, 'fields'>;
/**
 * Ignore memo
 *
 * Mark a memo as ignored (false positive or accepted risk).
 */
declare const ignoreMemo: <ThrowOnError extends boolean = false>(
 ...
 */
declare const downloadRepository: <ThrowOnError extends boolean = false>(
  options: Options<DownloadRepositoryData, ThrowOnError>
) => RequestResult<DownloadRepositoryResponses, DownloadRepositoryErrors, ThrowOnError, 'fields'>;
/**
 * Get download status
 *
 * Returns the current status and progress of a repository download job.
 */
declare const getRepoDownloadStatus: <ThrowOnError extends boolean = false>(
 ...
 */
declare const listDownloadedRepos: <ThrowOnError extends boolean = false>(
  options?: Options<ListDownloadedReposData, ThrowOnError>
) => RequestResult<ListDownloadedReposResponses, ListDownloadedReposErrors, ThrowOnError, 'fields'>;
/**
 * Delete repository
 *
 * Permanently deletes a downloaded repository. Accepts UUID or owner/repo format.
 */
declare const deleteRepo: <ThrowOnError extends boolean = false>(
  options: Options<DeleteRepoData, ThrowOnError>
) => RequestResult<DeleteRepoResponses, DeleteRepoErrors, ThrowOnError, 'fields'>;
/**
 ...
 */
declare const syncAllRepos: <ThrowOnError extends boolean = false>(
  options?: Options<SyncAllReposData, ThrowOnError>
) => RequestResult<SyncAllReposResponses, SyncAllReposErrors, ThrowOnError, 'fields'>;
/**
 ...
 */
declare const getRepoCommits: <ThrowOnError extends boolean = false>(
  options: Options<GetRepoCommitsData, ThrowOnError>
) => RequestResult<GetRepoCommitsResponses, GetRepoCommitsErrors, ThrowOnError, 'fields'>;
/**
 * Sync repository
 *
 ...
 */
declare const syncRepo: <ThrowOnError extends boolean = false>(
  options: Options<SyncRepoData, ThrowOnError>
) => RequestResult<SyncRepoResponses, SyncRepoErrors, ThrowOnError, 'fields'>;
/**
 * Github Check Access
 *
 ...
 */
declare const githubCheckAccess: <ThrowOnError extends boolean = false>(
  options: Options<GithubCheckAccessData, ThrowOnError>
) => RequestResult<GithubCheckAccessResponses, GithubCheckAccessErrors, ThrowOnError, 'fields'>;
/**
 ...
 * Uses the user's stored GitHub token for private repository access.
 */
declare const githubListBranches: <ThrowOnError extends boolean = false>(
  options: Options<GithubListBranchesData, ThrowOnError>
) => RequestResult<GithubListBranchesResponses, GithubListBranchesErrors, ThrowOnError, 'fields'>;
/**
 * Github Get Contents
 *
 ...
 * Uses the user's stored GitHub token for private repository access.
 */
declare const githubGetContents: <ThrowOnError extends boolean = false>(
  options: Options<GithubGetContentsData, ThrowOnError>
) => RequestResult<GithubGetContentsResponses, GithubGetContentsErrors, ThrowOnError, 'fields'>;
/**
 * List all database configurations
 *
 * Returns all database configurations in the workspace. Supports offset-based pagination.
 */
declare const listDatabases: <ThrowOnError extends boolean = false>(
  options?: Options<ListDatabasesData, ThrowOnError>
) => RequestResult<ListDatabasesResponses, ListDatabasesErrors, ThrowOnError, 'fields'>;
/**
 * Create a new database configuration
 *
 * Creates a database configuration with auto-generated UUID. Use postgres_lambda for Lambda-proxied connections.
 */
declare const createDatabase: <ThrowOnError extends boolean = false>(
  options: Options<CreateDatabaseData, ThrowOnError>
) => RequestResult<CreateDatabaseResponses, CreateDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Delete database configuration
 *
 * Permanently deletes a database configuration.
 */
declare const deleteDatabase: <ThrowOnError extends boolean = false>(
  options: Options<DeleteDatabaseData, ThrowOnError>
) => RequestResult<DeleteDatabaseResponses, DeleteDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Get database configuration details
 *
 * Returns full database configuration including connection settings and allowed tables.
 */
declare const getDatabase: <ThrowOnError extends boolean = false>(
  options: Options<GetDatabaseData, ThrowOnError>
) => RequestResult<GetDatabaseResponses, GetDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Update database configuration
 *
 * Updates database configuration. Only provided fields are updated.
 */
declare const updateDatabase: <ThrowOnError extends boolean = false>(
  options: Options<UpdateDatabaseData, ThrowOnError>
) => RequestResult<UpdateDatabaseResponses, UpdateDatabaseErrors, ThrowOnError, 'fields'>;
/**
 * Test database connection
 *
 * Tests the database connection and returns status.
 */
declare const testDatabaseConnection: <ThrowOnError extends boolean = false>(
 ...
 */
declare const getSchema: <ThrowOnError extends boolean = false>(
  options?: Options<GetSchemaData, ThrowOnError>
) => RequestResult<GetSchemaResponses, GetSchemaErrors, ThrowOnError, 'fields'>;
/**
 * Get sample data from table
 *
 * Returns sample rows from a specified table.
 */
declare const getSample: <ThrowOnError extends boolean = false>(
  options: Options<GetSampleData, ThrowOnError>
) => RequestResult<GetSampleResponses, GetSampleErrors, ThrowOnError, 'fields'>;
/**
 * List available tables
 *
 * Returns list of tables available in the database. Supports caching.
 */
declare const listTables: <ThrowOnError extends boolean = false>(
  options?: Options<ListTablesData, ThrowOnError>
) => RequestResult<ListTablesResponses, ListTablesErrors, ThrowOnError, 'fields'>;
/**
 * List configured databases
 *
 * Returns list of database configurations available in the workspace.
 */
declare const listContextDatabases: <ThrowOnError extends boolean = false>(
 ...
 */
declare const getContentTypes: <ThrowOnError extends boolean = false>(
  options?: Options<GetContentTypesData, ThrowOnError>
) => RequestResult<GetContentTypesResponses, GetContentTypesErrors, ThrowOnError, 'fields'>;
/**
 * List content
 *
 * Lists all content items of a specific type, optionally filtered by path.
 */
declare const listContent: <ThrowOnError extends boolean = false>(
  options: Options<ListContentData, ThrowOnError>
) => RequestResult<ListContentResponses, ListContentErrors, ThrowOnError, 'fields'>;
/**
 * Query content
 *
 * Advanced query with filters on name, path, size, etc. Supports eq, ne, contains, startsWith, gt, lt operators.
 */
declare const queryContent: <ThrowOnError extends boolean = false>(
  options: Options<QueryContentData, ThrowOnError>
) => RequestResult<QueryContentResponses, QueryContentErrors, ThrowOnError, 'fields'>;
/**
 * Search content
 *
 * Full-text search in content names and paths. Case-insensitive.
 */
declare const searchContent: <ThrowOnError extends boolean = false>(
  options: Options<SearchContentData, ThrowOnError>
) => RequestResult<SearchContentResponses, SearchContentErrors, ThrowOnError, 'fields'>;
/**
 * Get content tree
 *
 * Returns hierarchical tree structure of content with configurable depth.
 */
declare const getContentTree: <ThrowOnError extends boolean = false>(
  options: Options<GetContentTreeData, ThrowOnError>
) => RequestResult<GetContentTreeResponses, GetContentTreeErrors, ThrowOnError, 'fields'>;
/**
 * Get content statistics
 *
 * Returns file counts and sizes grouped by extension for a content path.
 */
declare const getContentStats: <ThrowOnError extends boolean = false>(
  options: Options<GetContentStatsData, ThrowOnError>
) => RequestResult<GetContentStatsResponses, GetContentStatsErrors, ThrowOnError, 'fields'>;
/**
 * Delete content
 *
 * Deletes content. Use recursive=true with confirm=true to delete directories.
 */
declare const deleteContent: <ThrowOnError extends boolean = false>(
  options: Options<DeleteContentData, ThrowOnError>
) => RequestResult<DeleteContentResponses, DeleteContentErrors, ThrowOnError, 'fields'>;
/**
 * Read content
 *
 * Reads content by type and path. Binary files are base64-encoded. Use versionId param to read a specific version.
 */
declare const readContent: <ThrowOnError extends boolean = false>(
  options: Options<ReadContentData, ThrowOnError>
) => RequestResult<ReadContentResponses, ReadContentErrors, ThrowOnError, 'fields'>;
/**
 * Write content
 *
...
) => RequestResult<WriteContentResponses, WriteContentErrors, ThrowOnError, 'fields'>;
/**
 * Move content
 *
 * Moves content from source to destination path. Use overwrite=true to replace existing.
 */
declare const moveContent: <ThrowOnError extends boolean = false>(
  options: Options<MoveContentData, ThrowOnError>
) => RequestResult<MoveContentResponses, MoveContentErrors, ThrowOnError, 'fields'>;
/**
 * Lock content
 *
 * Acquires an exclusive lock on content for the specified TTL (seconds). Stub endpoint for SDK compatibility.
 */
declare const lockContent: <ThrowOnError extends boolean = false>(
  options: Options<LockContentData, ThrowOnError>
) => RequestResult<LockContentResponses, LockContentErrors, ThrowOnError, 'fields'>;
/**
 * Unlock content
 *
 * Releases an exclusive lock on content. Stub endpoint for SDK compatibility.
 */
declare const unlockContent: <ThrowOnError extends boolean = false>(
  options: Options<UnlockContentData, ThrowOnError>
) => RequestResult<UnlockContentResponses, UnlockContentErrors, ThrowOnError, 'fields'>;
/**
 * Create a new mission
 *
 * Creates a mission with optional project association and goals list.
 */
declare const toolCreateMission: <ThrowOnError extends boolean = false>(
  options: Options<ToolCreateMissionData, ThrowOnError>
) => RequestResult<ToolCreateMissionResponses, ToolCreateMissionErrors, ThrowOnError, 'fields'>;
/**
 * Update mission status
 *
 * Updates mission status, progress percentage, and/or notes.
 */
declare const toolUpdateMission: <ThrowOnError extends boolean = false>(
  options: Options<ToolUpdateMissionData, ThrowOnError>
) => RequestResult<ToolUpdateMissionResponses, ToolUpdateMissionErrors, ThrowOnError, 'fields'>;
/**
 * Get mission context
 *
 * Returns mission context data optimized for AI consumption.
 */
declare const getMissionContext: <ThrowOnError extends boolean = false>(
  options: Options<GetMissionContextData, ThrowOnError>
) => RequestResult<GetMissionContextResponses, GetMissionContextErrors, ThrowOnError, 'fields'>;
/**
 ...
 */
declare const loginForAccessToken: <ThrowOnError extends boolean = false>(
  options: Options<LoginForAccessTokenData, ThrowOnError>
) => RequestResult<LoginForAccessTokenResponses, LoginForAccessTokenErrors, ThrowOnError, 'fields'>;
/**
 * Login
 *
 ...
 */
declare const login: <ThrowOnError extends boolean = false>(
  options: Options<LoginData, ThrowOnError>
) => RequestResult<LoginResponses, LoginErrors, ThrowOnError, 'fields'>;
/**
 * Refresh Tokens
 *
 ...
 */
declare const refreshTokens: <ThrowOnError extends boolean = false>(
  options: Options<RefreshTokensData, ThrowOnError>
) => RequestResult<RefreshTokensResponses, RefreshTokensErrors, ThrowOnError, 'fields'>;
/**
 * Get Auth Config
 *
 ...
 */
declare const getAuthConfig: <ThrowOnError extends boolean = false>(
  options?: Options<GetAuthConfigData, ThrowOnError>
) => RequestResult<GetAuthConfigResponses, unknown, ThrowOnError, 'fields'>;
/**
 * Get Current User
 *
 * Get current authenticated user info.
 */
declare const getCurrentUser: <ThrowOnError extends boolean = false>(
  options?: Options<GetCurrentUserData, ThrowOnError>
) => RequestResult<GetCurrentUserResponses, GetCurrentUserErrors, ThrowOnError, 'fields'>;
/**
 * List Workspaces
 *
 * List workspaces for authenticated user.
 */
declare const listWorkspaces: <ThrowOnError extends boolean = false>(
  options?: Options<ListWorkspacesData, ThrowOnError>
) => RequestResult<ListWorkspacesResponses, ListWorkspacesErrors, ThrowOnError, 'fields'>;
...
declare class ProjectNamespace {
   ...
   */
  create(data: { name: string; description?: string }): Promise<ProjectResponse>;
  /**
   * Update a project
   */
...
declare class SessionNamespace {
   ...
   */
  list(options?: { status?: string; limit?: number }): Promise<SessionListResponse>;
  /**
   * Get session messages
 ...
 */
declare function createResponseSchema<T extends z.ZodTypeAny>(
  dataSchema: T
): z.ZodObject<
  {
    success: z.ZodBoolean;
 ...
 */
declare const WSMessageSchema: z.ZodDiscriminatedUnion<
  [
    z.ZodObject<
      {
        id: z.ZodOptional<z.ZodString>;
...
export {
  ...
  type ContextReposData,
  ContextReposDataSchema,
  type ContextReposResponse,
