...
export const getContentTypes = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<GetContentTypesResponses, unknown, ThrowOnError>({
...
export const listContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<ListContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/list',
    ...options,
  });
...
export const deleteContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).delete<DeleteContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/{id}',
    ...options,
  });
...
export const readContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<ReadContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/{id}',
    ...options,
  });
...
export const writeContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<WriteContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/{id}',
    ...options,
    headers: {
...
export const queryContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<QueryContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/query',
    ...options,
    headers: {
...
export const searchContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<SearchContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getContentTree = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<GetContentTreeResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/tree',
    ...options,
  });
...
export const getContentStats = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<GetContentStatsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/{type}/stats',
    ...options,
  });
...
export const bulkReadContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<BulkReadContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const bulkWriteContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<BulkWriteContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const bulkDeleteContent = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<BulkDeleteContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const queryKnowledgeBase = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<QueryKnowledgeBaseResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/kb/query',
    ...options,
    headers: {
...
export const ragKnowledgeBase = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<RagKnowledgeBaseResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/kb/rag',
    ...options,
    headers: {
...
export const downloadRepository = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<DownloadRepositoryResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getRepoDownloadStatus = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<GetRepoDownloadStatusResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const listDownloadedRepos = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<ListDownloadedReposResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/repo/list',
    ...options,
  });
...
export const githubCheckAccess = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<GithubCheckAccessResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const githubListBranches = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<GithubListBranchesResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const githubGetContents = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<GithubGetContentsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const createMission = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<CreateMissionResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const updateMission = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<UpdateMissionResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getMissionContext = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<GetMissionContextResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const discoverSimilar = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<DiscoverSimilarResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/tools/discover',
    ...options,
    headers: {
...
export const findByTicket = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<FindByTicketResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const lockContent = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).post<LockContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/lock',
    ...options,
    headers: {
...
export const unlockContent = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).post<UnlockContentResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/ocxp/unlock',
    ...options,
    headers: {
