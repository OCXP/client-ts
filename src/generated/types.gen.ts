...
export type AgentHealthResponse = {
   ...
   * Ocxp Healthy
   */
  ocxp_healthy: boolean;
  /**
   * Agentcore Healthy
   */
  agentcore_healthy: boolean;
  /**
   * Agentcore Url
   */
...
export type AgentInvokeRequest = {
   ...
   * Action
   *
   * Action type: process_mission, retrigger_task, chat
   */
  action: string;
  /**
   * Mission data for process_mission action
   */
  mission?: MissionInput | null;
  /**
   * Project Id
   *
   * Project UUID to associate with (deprecated, use mission.project_id)
   */
  project_id?: string | null;
  /**
   * Content
   *
   * Mission content or prompt (deprecated, use mission.description)
   */
  content?: string | null;
  /**
   * Mission Id
   *
   * Existing mission ID (optional, auto-created if not provided)
   */
  mission_id?: string | null;
  /**
   * Task Id
   *
   * For retrigger_task action
   */
  task_id?: string | null;
  /**
   * Reason
   ...
   * Custom intake types
   */
  requested_intake?: Array<unknown> | null;
  /**
   * Requested Outputs
   *
   * Custom output config
   */
  requested_outputs?: Array<unknown> | null;
  [key: string]:
    | unknown
    | string
    | MissionInput
 ...
 *
 * Response for archive workflows endpoint.
 */
export type ArchiveWorkflowsResponse = {
  /**
   * Archived Count
   *
 ...
 */
export type CleanupDeadReposResponse = {
  /**
   * Projects Scanned
   */
 ...
 * DiscoverMetrics
 *
 * Metrics for context discovery - used for Langfuse dashboard.
 *
...
export type DiscoverMetrics = {
   ...
   * Internal Total
   *
   * Total results from internal KB
   */
  internal_total?: number;
  /**
   * Internal Max Score
   *
   * Highest relevance score from internal KB
   */
  internal_max_score?: number;
  /**
   * Internal Avg Score
   *
   * Average relevance score from internal KB
   */
  internal_avg_score?: number;
  /**
   * Internal Code Hits
   *
   * Results from code KB
   */
  internal_code_hits?: number;
  /**
   * Internal Docs Hits
   *
   * Results from docs KB
   */
  internal_docs_hits?: number;
  /**
   * External Total
   *
   * Total results from external sources (Context7, AWS docs)
   */
  external_total?: number;
  /**
   * External Max Score
   *
   * Highest relevance score from external sources
   */
  external_max_score?: number;
  /**
   * Fallback Triggered
   *
   * Whether fallback to external sources was triggered
   */
  fallback_triggered?: boolean;
  /**
   * Fallback Reason
   *
   * Why fallback was triggered: low_score, no_results, null if not triggered
   */
  fallback_reason?: string | null;
  /**
   * Fallback Source
   *
   * External source used: context7, aws_docs
   */
  fallback_source?: string | null;
  /**
   * Query Decomposed
   *
   * Whether query was decomposed into sub-queries
   */
...
export type DiscoverResponse = {
  ...
  /**
   * Discovery metrics for Langfuse evaluation dashboard
   */
  metrics?: DiscoverMetrics | null;
};

/**
 * DocumentGenerationRequest
 *
 * Request to generate specific document types for a mission.
 */
export type DocumentGenerationRequest = {
  /**
   * Doc Types
   *
   * List of document types to generate (e.g., ['implementation-guide', 'prd', 'architecture-decisions'])
   */
  doc_types: Array<string>;
  /**
   * Session Id
   *
   * Optional specific agentcore session to use. If not provided, uses most recent active session.
   */
  session_id?: string | null;
};
 ...
 *
 * Response for document generation request.
 */
...
export type MissionInput = {
   ...
   * Project Id
   *
   * Project UUID to associate with
   */
  project_id?: string | null;
};
 ...
 */
export type RepoPullRequestInfo = {
  /**
   * Number
   *
   * PR number
   ...
   * Updated At
   *
   * Last update date ISO timestamp
   */
  updated_at: string;
  /**
   * Url
 ...
 *
 * Response for GET /ocxp/repo/{id}/pulls.
 */
export type RepoPullRequestsResponse = {
   ...
   */
  pull_requests?: Array<RepoPullRequestInfo>;
  /**
   * Total
   *
 ...
 */
export type WorkflowStatus = 'pending' | 'running' | 'paused' | 'completed' | 'failed' | 'archived';
...
export type CleanupDeadReposData = {
  body?: never;
  headers?: {
    /**
     * X-Workspace
...
export type CleanupDeadReposErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type CleanupDeadReposError = CleanupDeadReposErrors[keyof CleanupDeadReposErrors];

export type CleanupDeadReposResponses = {
  /**
   * Cleanup completed successfully
   */
  200: CleanupDeadReposResponse;
};

export type CleanupDeadReposResponse2 = CleanupDeadReposResponses[keyof CleanupDeadReposResponses];
...
export type CreateMissionDocumentsData = {
...
export type CreateMissionDocumentsErrors = {
  /**
   * Mission or session not found
   */
  404: unknown;
  /**
   * Invalid document types or request
   */
  422: unknown;
};

export type CreateMissionDocumentsResponses = {
  /**
...
export type CreateMissionDocumentsResponse =
  CreateMissionDocumentsResponses[keyof CreateMissionDocumentsResponses];

export type GetDocumentsStatusData = {
  body?: never;
  headers?: {
    /**
     * X-Workspace
...
export type GetDocumentsStatusErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type GetDocumentsStatusError = GetDocumentsStatusErrors[keyof GetDocumentsStatusErrors];

export type GetDocumentsStatusResponses = {
  /**
   * Successful Response
   */
  200: unknown;
...
export type ArchiveWorkflowsForMissionData = {
  body?: never;
  headers?: {
    /**
     * X-Workspace
...
export type ArchiveWorkflowsForMissionErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type ArchiveWorkflowsForMissionError =
  ArchiveWorkflowsForMissionErrors[keyof ArchiveWorkflowsForMissionErrors];

export type ArchiveWorkflowsForMissionResponses = {
  /**
   * Workflows archived successfully
   */
  200: ArchiveWorkflowsResponse;
};

export type ArchiveWorkflowsForMissionResponse =
  ArchiveWorkflowsForMissionResponses[keyof ArchiveWorkflowsForMissionResponses];
...
export type AgentHealthResponses = {
  /**
   * Health status
   */
...
export type AgentHealthResponse2 = AgentHealthResponses[keyof AgentHealthResponses];
...
export type GetRepoPullsErrors = {
  /**
   * Repository not found
   */
  404: unknown;
...
export type GetRepoPullsError = GetRepoPullsErrors[keyof GetRepoPullsErrors];

export type GetRepoPullsResponses = {
  /**
   * Pull requests returned
   */
  200: RepoPullRequestsResponse;
};

export type GetRepoPullsResponse = GetRepoPullsResponses[keyof GetRepoPullsResponses];
