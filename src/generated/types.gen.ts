 ...
 *
 * Request to generate mission output via workflow.
 */
export type OutputGenerationRequest = {
  /**
   * Output Type
   *
   * Type of output: 'documents', 'report', 'summary', etc.
   */
  output_type: string;
  /**
   * Doc Types
   *
   * For output_type='documents': which document types to generate
   */
  doc_types?: Array<string> | null;
  /**
   * Strategy
   *
   * Generation strategy: 'generate_all', 'regenerate_changed', 'auto_select'
   */
  strategy?: string;
  /**
   * Session Id
   *
   * Optional: specific agentcore session to use
   */
  session_id?: string | null;
  /**
   * Options
 ...
 *
 * Response from output generation -- returns workflow for tracking.
 */
export type OutputGenerationResponse = {
  /**
   * Workflow Id
   */
  workflow_id: string;
...
export type GenerateMissionOutputData = {
  body: OutputGenerationRequest;
  headers?: {
    /**
     * Authorization
     */
...
export type GenerateMissionOutputErrors = {
  /**
   * Mission not found
   */
  404: unknown;
...
export type GenerateMissionOutputResponses = {
  /**
   * Workflow created and generation started
   */
  201: OutputGenerationResponse;
};

export type GenerateMissionOutputResponse =
  GenerateMissionOutputResponses[keyof GenerateMissionOutputResponses];
